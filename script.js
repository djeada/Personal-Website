...
function prepareEnemies(){
	enemies.push({el: $("#enemy1"), top: parseInt(Math.random()*screenHeight), left: parseInt(Math.random()*screenWidth), directionX: 1, directionY: 1});
	enemies.push({el: $("#enemy2"), top: parseInt(Math.random()*screenHeight), left: parseInt(Math.random()*screenWidth), directionX: 1, directionY: 1});
	enemies.push({el: $("#enemy3"), top: parseInt(Math.random()*screenHeight), left: parseInt(Math.random()*screenWidth), directionX: 1, directionY: 1});
	enemies.push({el: $("#enemy4"), top: parseInt(Math.random()*screenHeight), left: parseInt(Math.random()*screenWidth), directionX: 1, directionY: 1});
	enemies.push({el: $("#enemy5"), top: parseInt(Math.random()*screenHeight), left: parseInt(Math.random()*screenWidth), directionX: 1, directionY: 1});
	enemies.push({el: $("#enemy6"), top: parseInt(Math.random()*screenHeight), left: parseInt(Math.random()*screenWidth), directionX: 1, directionY: 1});
}
